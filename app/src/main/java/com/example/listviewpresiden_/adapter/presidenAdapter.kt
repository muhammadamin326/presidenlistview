...
import com.example.listviewpresiden_.model.BioPresiden.listPresiden
import com.example.listviewpresiden_.model.Presiden

class presidenAdapter (private val ListPresiden: Context, private val presiden : ArrayList<Presiden>, private val listener: (Presiden) -> Unit)
    : RecyclerView.Adapter<presidenAdapter.ViewHolder>(){
